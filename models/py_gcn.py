...
class NodeModel_1(torch.nn.Module):
    def __init__(self):
        ...
        self.node_mlp_1 = GCNConv(144, 168)
...
class NodeModel_2(torch.nn.Module):
    def __init__(self):
        ...
        self.node_mlp_1 = GCNConv(424, 256)
...
class EdgeModel_3(torch.nn.Module):
    def __init__(self):
        ...
        self.edge_mlp = Sequential(Linear(800, 316), ReLU())
...
class NodeModel_3(torch.nn.Module):
    def __init__(self):
        ...
        self.node_mlp_1 = GCNConv(632, 512)
...
class EdgeModel_4(torch.nn.Module):
    def __init__(self):
        ...
        self.edge_mlp = Sequential(Linear(1552, 614), ReLU())
...
class NodeModel_4(torch.nn.Module):
    def __init__(self):
        ...
        self.node_mlp_1 = GCNConv(1232, 864)
...
class EdgeModel_5(torch.nn.Module):
    def __init__(self):
        ...
        self.edge_mlp = Sequential(Linear(622, 1), ReLU())
...
class PY_SYN_METAAS(torch.nn.Module):
    def __init__(self):
        ...
        self.gc4 =   GCNConv(512, 618)       
        self.meta4 = MetaLayer_t(EdgeModel_4(), NodeModel_4())
        
        self.gc5 =   GCNConv(864, 4)       
